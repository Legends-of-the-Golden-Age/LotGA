...
function create_fragment(ctx) {
  ...
  return {
    c() {
      ...
      attr(input0, "class", "name-input flex-obj");
      ...
      attr(input1, "class", "value-input flex-obj");
      attr(div, "class", "modal-input-container");
    },
    m(target, anchor) {
...
function create_fragment2(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "modal-inputs-container");
      attr(a, "class", "a-btn");
      attr(a, "href", "href");
...
var PropForm = class extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance2, create_fragment2, safe_not_equal, { submission: 5, override: 6 });
  }
  get override() {
    return this.$$.ctx[6];
  }
...
var MultiPropPlugin = class extends import_obsidian2.Plugin {
  async onload() {
    this.registerEvent(
...
var customProps = {
  ...
  rht: true,
  aliases: ["alias", "alias"],
  testProp: "1992-02-12T03:03",
  //If string is typed in this specific format, it will be read as datetime.
  testProp2: "09-05-2023"
};
function addProperties(props, overwrite, frontmatter) {
  var _a;
...
function FilesOrFolders(app, arr, customProps2) {
  for (let el of arr) {
    if (el instanceof import_obsidian2.TFile && el.extension === "md") {
      app.fileManager.processFrontMatter(el, (frontmatter) => {
        addProperties(customProps2, true, frontmatter);
      });
    }
  }
}
function searchThroughFolders(app, obj, customProps2) {
  for (let child of obj.children) {
    if (child instanceof import_obsidian2.TFolder) {
      searchThroughFolders(app, child, customProps2);
    }
